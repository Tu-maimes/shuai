...
public interface SpeakerMapper {
	...
	List<Speaker> selectBySpeaker(@Param("job")String job, @Param("name") String name, @Param("page") Integer page);

	Integer selectBySpeakerCount(@Param("job")String job, @Param("name") String name);
}