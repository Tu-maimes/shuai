...
<head>
  ...
  <body>
    ...
    <form class="form-horizontal" enctype="multipart/form-data" action="${pageContext.request.contextPath}/speaker/speakeradd.action">
						  <div class="bs-example" data-example-id="simple-table">
						  	<div style="text-align: center; width: 1200px;">
  <div class="form-group">
    <label class="col-sm-2 control-label" for="formGroupInputLarge">名字:</label>
    <div class="col-sm-8">
      <input class="form-control" type="text"  name="speakerName" placeholder="主讲人姓名">
    </div>
  </div>
  <div class="form-group ">
    <label class="col-sm-2 control-label" for="formGroupInputSmall">职业:</label>
    <div class="col-sm-8">
      <input class="form-control" type="text" name="speakerJob" placeholder="主讲人职业">
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label" for="formGroupInputSmall">头像:</label>
    <div class="col-sm-8">
      <input class="form-control" type="text" name="speakerHead_url" placeholder="主讲人头像地址">
    </div>
  </div>
  <div class="form-group">
		        <label for="inputEmail3" class="col-sm-2 control-label">简介:</label>
		        <div class="bs-example" data-example-id="textarea-form-control">
			  <textarea class="col-sm-8 " rows="2" placeholder="Textarea" name = "speakerDescr"></textarea>
			 </div>
   </div>
  </div>
  </div>
