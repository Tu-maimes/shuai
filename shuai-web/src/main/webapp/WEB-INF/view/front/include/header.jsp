	...
	<div class="container">
		...
		<c:if test="${not empty _front_user}">
			<div id="userBlock" style="float:right">
				...
				<a href="front/user/index/${_front_user.id}.do">${sessionScope._front_user.email }</a>
			</div>
		</c:if>
		...
		<a target="_blank" href="${pageContext.request.contextPath}/adminMan/login.action"><img src="static/img/we.png" draggable="false">后台管理</a>
