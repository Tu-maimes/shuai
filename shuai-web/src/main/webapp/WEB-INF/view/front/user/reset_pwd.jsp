...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="front/user/resetpwd.do" method="post" id="regForm">
               <input type="hidden" name="email" value="${userppp.email}"/>
                <input type="hidden" name="captcha" value="${userppp.captcha}"/>
                <input type="hidden" name="id" value="${userppp.id}"/>
                ...
                <div class="form_body">
                    <input type="password" placeholder="请输入新密码" id="regPsw" name="password">
